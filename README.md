...
Disclaimer (pt_BR)
==========
Este repositório é uma versão modificada do pacote [nicolaslopezj/searchable](https://github.com/nicolaslopezj/searchable). Algumas mudanças foram implementadas para uma melhor integração com as demais libs do projeto [Versatile](https://github.com/versatilecms).
...
```
"versatilelibs/laravel-searchable": "1.*"
```
